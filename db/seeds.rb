...
flat7 = Flat.create!(
  ...
  description: "This elegant two-bedroom apartment is located in the prestigious Salamanca District.",
...
flat8 = Flat.create!(
  ...
  description: "Luxury apartment with two bedrooms and two bathrooms in one of the most exclusive areas of London.",
